...
export const manifiestos = pgTable("manifiestos", {
  ...
  mercancia_informacion_remitente_2: text("mercancia_informacion_remitente_2"),
  ...
  mercancia_informacion_destinatario_2: text("mercancia_informacion_destinatario_2"),
