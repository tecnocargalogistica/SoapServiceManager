...
export default function CargaVehiculos() {
  ...
  const descargarPlantilla = async () => {
    try {
      const response = await fetch('/api/vehiculos/plantilla');
  ...
  const procesarArchivo = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/vehiculos/carga-masiva', {
        method: 'POST',
        body: formData,
      });
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold">Carga Masiva de Vehículos</h1>
          <p className="text-muted-foreground">
            Sube un archivo Excel o CSV con la información de tus vehículos
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Descarga la plantilla con los campos requeridos para cargar vehículos
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <Alert>
            ...
            <AlertDescription>
              <strong>Campos obligatorios:</strong> PLACA, CAPACIDAD_CARGA, PROPIETARIO_NUMERO_DOC, PROPIETARIO_NOMBRE
              <br />
              <strong>Formatos de fecha:</strong> YYYY-MM-DD (ejemplo: 2025-12-31)
              <br />
              <strong>Capacidades:</strong> En kilogramos (ejemplo: 5000)
            </AlertDescription>
          </Alert>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Selecciona tu archivo Excel o CSV con los datos de los vehículos
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          {cargando && (
            <div className="space-y-2">
              ...
              <p className="text-sm text-center">Procesando vehículos...</p>
            </div>
          )}
        </CardContent>
      </Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-muted-foreground">Vehículos creados</div>
              </div>
              <div className="text-center">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium">
                        Fila {resultado.fila} - {resultado.placa}
                      </div>
                      <div className="text-sm text-muted-foreground">
                        {resultado.mensaje}
                      </div>
