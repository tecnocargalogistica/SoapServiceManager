...
export default function CargaTerceros() {
  ...
  const descargarPlantilla = async () => {
    try {
      const response = await fetch('/api/terceros/plantilla');
      const blob = await response.blob();
      const url = window.URL.createObjectURL(blob);
      const a = document.createElement('a');
      a.href = url;
      a.download = 'plantilla_terceros.csv';
  ...
  const procesarArchivo = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/terceros/carga-masiva', {
        method: 'POST',
        body: formData,
      });
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold">Carga Masiva de Terceros</h1>
          <p className="text-muted-foreground">
            Sube un archivo Excel o CSV con la información de terceros (clientes, proveedores, etc.)
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Descarga la plantilla con los campos requeridos para cargar terceros
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <Alert>
            ...
            <AlertDescription>
              ...
              <br />
              <strong>Campos disponibles:</strong> nombre, telefono, email, direccion, municipio_codigo, activo, razon_social, apellido, es_empresa, es_conductor, es_propietario, categoria_licencia, numero_licencia, fecha_vencimiento_licencia, id_vehiculo_asignado, es_responsable_sede
              <br />
              <strong>Tipos de documento:</strong> N (NIT), C (Cédula), P (Pasaporte), T (Tarjeta de Identidad)
              <br />
              <strong>Valores booleanos:</strong> true/false para campos es_empresa, es_conductor, es_propietario, es_responsable_sede, activo
              <br />
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Selecciona tu archivo Excel o CSV con los datos de los terceros
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          {cargando && (
            <div className="space-y-2">
              ...
              <p className="text-sm text-center">Procesando terceros...</p>
            </div>
          )}
        </CardContent>
      </Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-muted-foreground">Terceros creados</div>
              </div>
              <div className="text-center">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium">
                        Fila {resultado.fila} - {resultado.documento}
                      </div>
                      <div className="text-sm text-muted-foreground">
                        {resultado.mensaje}
                      </div>
