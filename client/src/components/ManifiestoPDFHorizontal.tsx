...
export class ManifiestoPDFHorizontalGenerator {
  ...
  private generateQRContent(): string {
    ...
    const origen = this.manifiesto.municipio_origen || 'FUNZA CUNDINAMARCA';
    qrContent += `Orig:${origen}\n`;
    
    // 6. Dest: Destino Viaje de la base de datos
    const destino = this.manifiesto.municipio_destino || 'GUADUAS CUNDINAMARCA';
    ...
    const valorTotal = this.manifiesto.valor_total_viaje || '765,684';
